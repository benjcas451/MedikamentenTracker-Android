...
android {
    namespace = "org.dwarftsch.medikamente"
    compileSdk {
        version = release(37)
    }
    ...
    defaultConfig {
        ...
        applicationId = "org.dwarftsch.medikamente"
        minSdk = 24
        targetSdk = 37
        // Muss beim Play-Upload strikt ueber dem letzten veroeffentlichten
        // versionCode der Flutter-App liegen (zuletzt 6). Die CI uebergibt
        // -PbuildNumber=100+run_number (siehe .github/workflows/build-aab.yml),
        // lokal gilt der Fallback.
        versionCode = (findProperty("buildNumber") as String?)?.toIntOrNull() ?: 7
        versionName = "2.0.0"
